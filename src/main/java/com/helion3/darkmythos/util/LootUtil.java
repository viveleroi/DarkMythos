...
public class LootUtil {
    public static void addItemToTable(LootTable table, Item item, int weight, float numRolls, float probability, String name) {
        addItemToTable(table, item, weight, numRolls, probability, name,
                lootfuncs -> {},
                lootconds -> {});
    }

    public static void addItemToTable(LootTable table, Item item, int weight, float numRolls, float probability, String name, IMethod LootCallbacks, ICondition LootConditions) {
